-- ==========================================
-- CORREÇÃO RÁPIDA: Adicionar coluna "role" à user_profiles
-- ==========================================
-- 
-- Script mínimo para corrigir o erro "column role does not exist"
-- 
-- Data: 2025-10-25
-- ==========================================
...
-- 3. Adicionar coluna 'name' se não existir (renomear full_name se necessário)
DO $$ 
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM information_schema.columns 
...
-- 6. Migrar dados de profile_type para role se necessário
DO $$ 
BEGIN
    IF EXISTS (
        SELECT 1 FROM information_schema.columns 
...
-- 8. Ativar RLS se não estiver ativo
ALTER TABLE user_profiles ENABLE ROW LEVEL SECURITY;

-- 9. Criar políticas básicas se não existirem
DO $$ 
BEGIN
    IF NOT EXISTS (
...
SELECT 'Correção rápida aplicada com sucesso! A coluna "role" foi adicionada.' as status;
