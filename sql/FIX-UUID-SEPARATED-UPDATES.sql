-- ============================================================================
-- KROMI - Fix UUID com UPDATEs separados
-- ============================================================================
-- Esta versão faz UPDATE de event_id e device_id em comandos separados
-- ============================================================================
...
BEGIN
    ...
    -- UPDATEs SEPARADOS para evitar problema de tipo
    -- UPDATE 1: event_id usando subquery direta
    ...
    -- UPDATE 2: device_id usando subquery direta
    UPDATE device_detections
    SET device_id = (
        SELECT ed.device_id 
        FROM event_devices ed 
    ...
    -- UPDATE 3: outros campos
    UPDATE device_detections
    SET device_order = v_checkpoint_order,
...
-- ============================================================================
-- ✅ CORREÇÃO APLICADA - UPDATEs SEPARADOS COM SUBQUERIES
-- ============================================================================
-- Esta versão:
-- 1. ✅ Faz UPDATE de event_id e device_id em comandos SEPARADOS
-- 2. ✅ Usa SUBQUERIES diretas (não variáveis) para evitar problema de tipo
-- 3. ✅ Isto garante que o PostgreSQL mantém o tipo correto
-- ============================================================================
