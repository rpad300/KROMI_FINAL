-- ============================================================================
-- KROMI - Fix UUID FINAL QUE FUNCIONA
-- ============================================================================
-- Solução: Buscar como TEXT e converter para UUID no UPDATE
-- ============================================================================
...
BEGIN
    ...
    -- Buscar informações do dispositivo COMO TEXT
    ...
    -- Atualizar cache em device_detections (TEXT -> UUID)
    ...
    IF v_has_dorsal THEN
        ...
        INSERT INTO detections (
            ...
            v_device_id_text,  -- Já é TEXT para detections
            v_checkpoint_order, 
            v_detection.captured_at, 
    ...
    ELSE
        ...
        INSERT INTO image_buffer (
            ...
            v_event_id_text::UUID,
            v_device_id_text,  -- Já é TEXT para image_buffer
            v_detection.session_id, 
...
-- ============================================================================
-- A chave é:
-- 1. Buscar device_id e event_id como TEXT (ed.device_id::TEXT)
-- 2. Guardar em variáveis TEXT
-- 3. Converter TEXT → UUID no UPDATE (v_device_id_text::UUID)
-- ============================================================================
