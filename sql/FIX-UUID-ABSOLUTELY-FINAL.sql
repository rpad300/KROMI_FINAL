-- ============================================================================
-- VERSÃO ABSOLUTAMENTE FINAL - baseada na debug que funcionou
-- ============================================================================
...
BEGIN
    ...
    -- BEGIN interno para capturar erros no UPDATE
    BEGIN
        ...
        IF v_has_dorsal THEN
            ...
            INSERT INTO detections (
                ...
                v_device_id_text,  -- TEXT para detections
                v_checkpoint_order, 
                v_detection.captured_at, 
        ...
        ELSE
            ...
            INSERT INTO image_buffer (
                ...
                v_event_id_text::UUID,
                v_device_id_text,  -- TEXT para image_buffer
                v_detection.session_id, 
...
-- ============================================================================
-- ✅ SOLUÇÃO FINAL - baseada na estrutura que funcionou
-- ============================================================================
